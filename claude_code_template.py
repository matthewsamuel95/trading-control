...
class TradingSystemClaudeTemplate:
        ...
        return [
            {
                ...
                "parameters": {
                    ...
                    "indicators": {"type": "array", "default": ["RSI", "MACD"], "description": "Technical indicators"},
                    "timeframe": {"type": "string", "default": "1d", "description": "Analysis timeframe"}
                },
            ...
            },
            {
                ...
                "parameters": {
                    "detailed": {"type": "boolean", "default": False, "description": "Show detailed metrics"}
                },
    ...
    async def _implement_analyze_command(self, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _implement_validate_command(self, params: Dict[str, Any]) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    print(f"🚀 Quick install: npx claude-code-templates@latest --agent {template.template_id} --yes")
